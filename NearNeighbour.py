...
def nearNeighbour(uRouteInput):
  ...
  # This node is added to the final route, the weight of the edges is added to the final length, and the original position of this node is the new row
  ...
  # The final route and total length is returned
